            ...
            <div class="card">
              <div class="card-header">
                  <ul class="nav nav-tabs card-header-tabs">
                    <li class="nav-item">
                      <a class="nav-link active" href="">Grooming</a>
                    </li>
                    <li class="nav-item">
              ...
              <div class="card-body">
                <h4 class="card-title">List Aktivitas Grooming</h4>
                <section id="gallery">
                  <div class="row">
                          ...
                          <div class="content d-flex flex-column justify-content-center">
                            <div class="row">
                                ...
                                <div class="card">
                                    ...
                                    <p>{{$value->service}}</p>
                                    <p>{{$value->petname}}</p>
                                    <p>{{ \Carbon\Carbon::parse($value->updated_at)->locale('id')->isoFormat('Do MMMM YYYY')}}</p>
