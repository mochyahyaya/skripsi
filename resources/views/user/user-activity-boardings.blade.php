            ...
            <div class="card">
              <div class="card-header">
                  <ul class="nav nav-tabs card-header-tabs">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="{{route('user/userActivityBreeds')}}">Breeding</a>
                    </li>
                  </ul>
                </div>
              <div class="card-body">
                <h4 class="card-title">List Aktivitas Boarding</h4>
                <section id="gallery">
                  <div class="row">
                          ...
                          <div class="content d-flex flex-column justify-content-center">
                            <div class="row">
                                ...
                                <div class="card">
                                    ...
                                    <p>{{$value->petname}}</p>
                                    <p>{{ \Carbon\Carbon::parse($value->start_at)->locale('id')->isoFormat('Do MMMM YYYY')}} - {{ \Carbon\Carbon::parse($value->start_at)->locale('id')->isoFormat('Do MMMM YYYY')}}</p>
