    ...
    <div class="container">
      ...
      <div class="row no-gutters">
        ...
        <div class="image col-xl-5 d-flex align-items-stretch justify-content-center order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
          <img src={!! asset('Appland/assets/img/features.svg') !!} class="img-fluid" alt="">
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row content">
        <div class="col-md-4" data-aos="fade-right">
          <img src={!! asset('Appland/assets/img/details-1.png') !!} class="img-fluid" alt="">
        </div>
      ...
      <div class="row content">
        <div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
          <img src={!! asset('Appland/assets/img/details-2.png') !!} class="img-fluid" alt="">
        </div>
      ...
      <div class="row content">
        <div class="col-md-4" data-aos="fade-right">
          <img src={!! asset('Appland/assets/img/details-3.png') !!} class="img-fluid" alt="">
        </div>
      ...
      <div class="row content">
        <div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
          <img src={!! asset('Appland/assets/img/details-4.png') !!} class="img-fluid" alt="">
        </div>
        <div class="col-md-8 pt-5 order-2 order-md-1" data-aos="fade-up">
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="testimonials-slider swiper" data-aos="fade-up" data-aos-delay="100">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="testimonial-item">
              <img src={!! asset('Appland/assets/img/testimonials/testimonials-5.jpg') !!} class="testimonial-img" alt="">
              <h3>John Larson</h3>
              <h4>Entrepreneur</h4>
              <p>
                <i class="bx bxs-quote-alt-left quote-icon-left"></i>
