        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" required class="phone_number form-control">
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-3">
                    <label for="">Phone No</label>
                    <input type="text" id="phone_number" required class="form-control">
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status == 404) {
                        ...
                        $('#address').val(response.student.course);
                        $('#email').val(response.student.email);
                        $('#phone_number').val(response.student.phone);
                        $('#stud_id').val(stud_id);
                    }
                }
            });
