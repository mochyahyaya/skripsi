...
class Inpatient extends Controller
{
    public function index()
    {
        $users = User::where('role_id', 3)->get();
        $pets = Pet::all();
        $hotels = Hotel::where('health_status', 'Inpatient')->get();
        $cages = Cage::all();
        return view('veterinarian.inpatient', compact('users', 'pets', 'hotels', 'cages'));
    }
